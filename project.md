...
There are two Garch Diffusion Model in [Garch.py](https://github.com/PyFE/PyFENG/blob/main/pyfeng/garch.py) from Pyfeng, one is <span style="color:red;">GarchUncorrBaroneAdesi2004</span> and the other is \textcolor(red){GarchMcTimeDisc} <span style="color:red;">GarchMcTimeDisc</span>
